...
const ECMode = /* @__PURE__ */ Object.freeze(['low', 'medium', 'quartile', 'high']);
/**
...
const _tests = /* @__PURE__ */ Object.freeze({
    Bitmap,
    info,
    detectType,
    encode,
...
export { Bitmap, ECMode, Encoding, _tests, encodeQR as default, encodeQR, utf8ToBytes, utils };
